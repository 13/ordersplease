export default {
  ...
  'weekly.archive': 'Weekly results',
  'compare.paste': 'Paste code',
  'compare.go': 'Compare',
  'compare.invalid': 'Invalid code',
  'compare.no-own': "You haven't played week {week}",
  'compare.result': 'You {mine} · Friend {theirs}',
  'compare.win': '— you win! 🏆',
  'compare.lose': '— they win',
  'compare.tie': '— tie',
  ...
  'badge.weekly-first': 'First weekly done',
  'badge.weekly-3': 'Three weekly weeks',
  'badge.level-40': 'Level 40 conquered',
  'badge.tips-10': 'Ten euros in tips',
  'badge.tips-100': 'A hundred in tips',
  'badge.stars-10': 'Ten perfect levels',
  'badge.rounds-100': 'A hundred rounds poured',
  'badge.career-wirt': 'Landlord',
  'career.aushilfe': 'Trainee',
  'career.barkeeper': 'Bartender',
  'career.schichtleiter': 'Shift Lead',
  'career.wirt': 'Landlord',
  'career.legende': 'Bar Legend',
  'menu.title': 'My menu',
  'menu.use-custom': 'Play with my menu',
  'menu.add': 'Add item',
  'menu.reorder': 'Reorder item',
  ...
  'menu.rename': 'Name',
  'menu.new-profile-name': 'New menu name',
  'menu.new-profile': 'New menu',
  'menu.delete-profile': 'Delete menu',
  'menu.delete-profile-confirm': 'Delete this menu? This cannot be undone.',
  'menu.presets': 'Festival presets',
  'menu.export': 'Export',
  'menu.import': 'Import',
  ...
  'settings.highlight-ordered': 'Highlight ordered items on the menu',
  ...
  'settings.left-hand': 'Left-handed layout',
  ...
  'bar.title': 'Bar',
  'bar.wallet': 'Tip wallet',
  'bar.buy': 'Buy',
  'bar.owned': 'Owned',
  'bar.ranked-note': 'Not active in daily & weekly',
  'bar.accent': 'Accent color',
  'bar.accent-default': 'Amber (default)',
  'bar.jar-xl.name': 'XL tip jar',
  'bar.jar-xl.desc': '+10% tips',
  'bar.coffee-machine.name': 'Coffee machine',
  'bar.coffee-machine.desc': 'Guests wait a second longer (levels & practice)',
  'bar.cheat-sheet.name': 'Cheat sheet',
  'bar.cheat-sheet.desc': 'First hint per shift is free',
  'bar.accent-copper.name': 'Copper counter',
  'bar.accent-copper.desc': 'Copper accent color',
  'bar.accent-forest.name': 'Forest counter',
  'bar.accent-forest.desc': 'Green accent color',
